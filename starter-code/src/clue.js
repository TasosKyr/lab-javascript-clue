...
randomElement = randomSelector(weaponsArray);
console.log(randomElement);

function pickMistery() {
    let misteri = [];
    misteri.push(randomSelector(charactersArray));
    misteri.push(randomSelector(weaponsArray));
    misteri.push(randomSelector(roomsArray));
    return misteri;
}
misteryEnvelope = pickMistery(charactersArray);
